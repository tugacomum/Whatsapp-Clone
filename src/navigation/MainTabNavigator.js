...
import NotImplementScreen from '../screens/NotImplementedScreen';
...
const MainTabNavigator = () => {
    return (
        <Tab.Navigator initialRouteName="Chats" screenOptions={{
            ...
            <Tab.Screen name="Status" component={NotImplementScreen} options={{
                tabBarIcon: ({ color, size }) => <Ionicons name="logo-whatsapp" size={size} color={color} />
            }} />
            <Tab.Screen name="Calls" component={NotImplementScreen} options={{
                tabBarIcon: ({ color, size }) => <Ionicons name="call-outline" size={size} color={color} />
            }} />
            <Tab.Screen name="Camera" component={NotImplementScreen} options={{
