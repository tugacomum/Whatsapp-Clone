...
import { ImageBackground, FlatList, StyleSheet, KeyboardAvoidingView, Platform, ActivityIndicator } from 'react-native';
...
const ChatScreen = () => {
    ...
    useEffect(()=>{
        ...
        const subcription = API.graphql(graphqlOperation(
